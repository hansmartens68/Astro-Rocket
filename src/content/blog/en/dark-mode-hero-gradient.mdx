...
The class is applied to the `Hero` component on any page that should carry the gradient. Currently that is the homepage and the projects page:
...
<Hero layout="centered" size="sm" class="hero-dark-gradient">
  ...
</Hero>
```

Adding it to any other page is a one-prop change.
