...
```html
<html lang="en" class="scroll-smooth dark" data-theme="magenta">
```

The `dark` class is what activates dark mode on first load. Remove it to default to light:

```html
<html lang="en" class="scroll-smooth" data-theme="magenta">
```
...
| `magenta` | 330° | Creative agencies, bold personal brands — maximum vivid — the default |
...
| Default colour theme | `src/layouts/BaseLayout.astro` | `data-theme="magenta"` |
