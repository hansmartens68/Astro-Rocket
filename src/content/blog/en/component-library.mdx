...
**See every component live:** [demo.deployvelocity.com/components](https://demo.deployvelocity.com/components)
...
When you need something that isn't in the library, Velocity's [component documentation](https://docs.deployvelocity.com/customization/adding-components/) describes exactly how to create new components that fit the existing patterns.
...
**[demo.deployvelocity.com/components](https://demo.deployvelocity.com/components)**
