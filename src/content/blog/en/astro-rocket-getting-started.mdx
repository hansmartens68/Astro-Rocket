...
imageAlt: "Lightning bolt icon above the words 'get started' on a dark background with a green-teal glow"
---
...
After purchasing, download the theme zip from your account and extract it:

```bash
unzip astro-rocket.zip -d my-site
cd my-site
npm install
npm run dev
```
