...
imageAlt: "Screenshot of the Astro Rocket homepage showing the hero section with the headline 'Astro Rocket — Web Designer & Developer'"
---
...
**Live theme switching with 13 colour themes** — Velocity required editing a CSS import file and rebuilding every time you wanted to change your brand colour. In Astro Rocket, you click one of the 7 colour bulbs in the header and everything updates on screen instantly: the logo badge, the blog image gradients, and every brand colour across the site. No file edits, no rebuilds. Once you've settled on a colour, you remove the selector from the header with a single line deletion.

The 7 active themes in the header are Lime, Emerald, Teal, Cyan, Sky, Blue, and Purple — Emerald is the default. Six additional themes (Orange, Amber, Magenta, Green, Indigo, Violet) are fully built and ready to activate. All 13 themes are based on the official Tailwind CSS colour palette.
