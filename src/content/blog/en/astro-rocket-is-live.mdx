...
All 12 themes are shown as swatches in the header: Orange, Amber, Lime, Emerald, Teal, Cyan, Sky, Blue, Indigo, Violet, Purple, and Magenta — Purple is the default. Every theme is based on the official Tailwind CSS colour palette.
