...
description: "A complete breakdown of every animation built into Astro Rocket — page transitions, scroll-triggered reveals, the reactive floating header, hero entrance, Lighthouse score arcs, and the full micro-animation library."
