...
// Replicate the CLI experience for astro-rocket-theme
const script: ScriptLine[] = [
  // Initial command
  { text: '$ pnpm create astro-rocket-theme@latest', delay: 1200, type: 'command' },
  { text: '', delay: 300, type: 'command' },

  // Intro banner (clack style)
  { text: '┌  Create Astro Rocket Theme', delay: 400, type: 'intro' },
